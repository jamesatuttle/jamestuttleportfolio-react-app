...
class About extends React.Component {
  render() {
    return (
      <section id='about_container' className='full_page_section page_width section_container'>
        <div id='about_container_text'>
          <h2>About Me</h2>
          <p>I grew up in the North East of England and completed my BSc. in Computer Science at Northumbria University.</p>
          <p>When I jumped into the world of work, I experimented in a few different roles within Computing until I found myself working as a Frontend Developer for a few companies. After a few varied experiences I found myself working at an Affiliate Marketing Company as a Platform Support Engineer helping to keep the Platform running, supporting Clients with customisation requests, building them custom signup tunnels to onboard affiliate partners and identifying and managing bugs/incidents.</p>
          ...
          <p>My ambition is to get involved in more Frontend Development with a focus on Accessibility, User Research and eventually transition into Design/UX.</p>
        </div>

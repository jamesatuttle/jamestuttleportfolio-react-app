...
class References extends React.Component {
  render() {
    return (
      <div>
        <MainHeader title="References" headerText="Images used throughout this website which aren't mine are referenced to their original authors and websites here." displayHeaderImage={false} />
